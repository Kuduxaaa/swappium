(function(e) {
	...
	"0825": function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "Capitalizzazione di mercato delle criptovalute aÃ‚ confronto"
			},
			coin_price_static_headline_widget: {
				powered_by: "Offerto da %{name_start}%{name}%{name_end}"
			},
	...
	"5d67": function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "ComparaÃƒÂ§ÃƒÂ£o de capitalizaÃƒÂ§ÃƒÂ£o de mercado de criptomoedas"
			},
			coin_price_static_headline_widget: {
				powered_by: "Fornecido por %{name_start}%{name}%{name_end}"
			},
	...
	"6ce2": function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "Vergleich der KryptowÃƒÂ¤hrungs-Marktkapitalisierung"
			},
			coin_price_static_headline_widget: {
				powered_by: "PrÃƒÂ¤sentiert von %{name_start}%{name}%{name_end}"
			},
	...
	7704: function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_price_comparison: "ÃÂ¡Ã‘â‚¬ÃÂ°ÃÂ²ÃÂ½ÃÂµÃÂ½ÃÂ¸ÃÂµ ÃÂºÃ‘Æ’Ã‘â‚¬Ã‘ÂÃÂ¾ÃÂ² ÃÂºÃ‘â‚¬ÃÂ¸ÃÂ¿Ã‘â€šÃÂ¾ÃÂ²ÃÂ°ÃÂ»Ã‘Å½Ã‘â€š",
				crypto_market_cap_comparison: "ÃÂ¡Ã‘â‚¬ÃÂ°ÃÂ²ÃÂ½ÃÂµÃÂ½ÃÂ¸ÃÂµ ÃÂºÃ‘â‚¬ÃÂ¸ÃÂ¿Ã‘â€šÃÂ¾ÃÂ²ÃÂ°ÃÂ»Ã‘Å½Ã‘â€š ÃÂ¿ÃÂ¾ Ã‘â‚¬Ã‘â€¹ÃÂ½ÃÂ¾Ã‘â€¡ÃÂ½ÃÂ¾ÃÂ¹ ÃÂºÃÂ°ÃÂ¿ÃÂ¸Ã‘â€šÃÂ°ÃÂ»ÃÂ¸ÃÂ·ÃÂ°Ã‘â€ ÃÂ¸ÃÂ¸"
			},
			coin_price_static_headline_widget: {
				powered_by: "ÃÅ¾Ã‘â€š %{name_start}%{name}%{name_end}"
			},
			...
			coin_market_ticker_list_widget: {
				...
				view_price_chart: "ÃÅ¸ÃÂ¾ÃÂºÃÂ°ÃÂ·ÃÂ°Ã‘â€šÃ‘Å’ ÃÂ³Ã‘â‚¬ÃÂ°Ã‘â€žÃÂ¸ÃÂº ÃÂ¸ÃÂ·ÃÂ¼ÃÂµÃÂ½ÃÂµÃÂ½ÃÂ¸Ã‘Â ÃÂºÃ‘Æ’Ã‘â‚¬Ã‘ÂÃÂ°",
				powered_by: "ÃÅ¾Ã‘â€š %{name_start}%{name}%{name_end}",
				view_all: "View all %{coin} markets"
			}
		}
	...
	8680: function(e) {
		e.exports = {
			coin_details: {
				mcap_rank: "Ã Â¸Â­Ã Â¸Â±Ã Â¸â„¢Ã Â¸â€Ã Â¸Â±Ã Â¸Å¡Ã Â¸Â¡Ã Â¸Â¹Ã Â¸Â¥Ã Â¸â€žÃ Â¹Ë†Ã Â¸Â²Ã Â¸â€¢Ã Â¸Â²Ã Â¸Â¡Ã Â¸Â£Ã Â¸Â²Ã Â¸â€žÃ Â¸Â²Ã Â¸â€¢Ã Â¸Â¥Ã Â¸Â²Ã Â¸â€",
			...
			coin_compare_chart_widget: {
				powered_by: "Ã Â¸â€šÃ Â¸Â±Ã Â¸Å¡Ã Â¹â‚¬Ã Â¸â€žÃ Â¸Â¥Ã Â¸Â·Ã Â¹Ë†Ã Â¸Â­Ã Â¸â„¢Ã Â¸â€Ã Â¹â€°Ã Â¸Â§Ã Â¸Â¢ %{name_start}%{name}%{name_end}",
				crypto_price_comparison: "Ã Â¸ÂÃ Â¸Â²Ã Â¸Â£Ã Â¹â‚¬Ã Â¸â€ºÃ Â¸Â£Ã Â¸ÂµÃ Â¸Â¢Ã Â¸Å¡Ã Â¹â‚¬Ã Â¸â€”Ã Â¸ÂµÃ Â¸Â¢Ã Â¸Å¡Ã Â¸Â£Ã Â¸Â²Ã Â¸â€žÃ Â¸Â² Crypto",
				crypto_market_cap_comparison: "Ã Â¸ÂÃ Â¸Â²Ã Â¸Â£Ã Â¹â‚¬Ã Â¸â€ºÃ Â¸Â£Ã Â¸ÂµÃ Â¸Â¢Ã Â¸Å¡Ã Â¹â‚¬Ã Â¸â€”Ã Â¸ÂµÃ Â¸Â¢Ã Â¸Å¡Ã Â¸Â¡Ã Â¸Â¹Ã Â¸Â¥Ã Â¸â€žÃ Â¹Ë†Ã Â¸Â²Ã Â¸â€¢Ã Â¸Â²Ã Â¸Â¡Ã Â¸Â£Ã Â¸Â²Ã Â¸â€žÃ Â¸Â²Ã Â¸â€¢Ã Â¸Â¥Ã Â¸Â²Ã Â¸â€Ã Â¸â€šÃ Â¸Â­Ã Â¸â€¡ Crypto"
			},
			coin_price_static_headline_widget: {
				powered_by: "Ã Â¸â€šÃ Â¸Â±Ã Â¸Å¡Ã Â¹â‚¬Ã Â¸â€žÃ Â¸Â¥Ã Â¸Â·Ã Â¹Ë†Ã Â¸Â­Ã Â¸â„¢Ã Â¸â€Ã Â¹â€°Ã Â¸Â§Ã Â¸Â¢ %{name_start}%{name}%{name_end}"
			},
	...
	"89b2": function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "PorÃƒÂ³wnanie dominacji w kapitalizacji rynku kryptowalut"
			},
			coin_price_static_headline_widget: {
				powered_by: "TreÃ…â€ºÃ„â€¡ dostarczona przez %{name_start}%{name}%{name_end}"
			},
	...
	a306: function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "ComparaciÃƒÂ³n de la capitalizaciÃƒÂ³n de mercado de las criptomonedas"
			},
			coin_price_static_headline_widget: {
				powered_by: "Con tecnologÃƒÂ­a de %{name_start}%{name}%{name_end}"
			},
	...
	aced: function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "So sÃƒÂ¡nh vÃ¡Â»â€˜n hÃƒÂ³a thÃ¡Â»â€¹ trÃ†Â°Ã¡Â»Âng tiÃ¡Â»Ân mÃƒÂ£ hÃƒÂ³a"
			},
			coin_price_static_headline_widget: {
				powered_by: "Ã„ÂÃ†Â°Ã¡Â»Â£c hÃ¡Â»â€” trÃ¡Â»Â£ bÃ¡Â»Å¸i %{name_start}%{name}%{name_end}"
			},
	...
	af08: function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_price_comparison: "Ã™â€¦Ã™â€šÃ˜Â§Ã˜Â±Ã™â€ Ã˜Â© Ã˜Â£Ã˜Â³Ã˜Â¹Ã˜Â§Ã˜Â± Ã˜Â§Ã™â€žÃ˜Â¹Ã™â€¦Ã™â€žÃ˜Â© Ã˜Â§Ã™â€žÃ™â€¦Ã˜Â´Ã™ÂÃ˜Â±Ã˜Â©",
				crypto_market_cap_comparison: "Ã™â€¦Ã™â€šÃ˜Â§Ã˜Â±Ã™â€ Ã˜Â© Ã˜Â³Ã™â€šÃ™Â Ã˜Â£Ã˜Â³Ã˜Â¹Ã˜Â§Ã˜Â± Ã˜Â³Ã™Ë†Ã™â€š Ã˜Â§Ã™â€žÃ˜Â¹Ã™â€¦Ã™â€žÃ˜Â§Ã˜Âª Ã˜Â§Ã™â€žÃ™â€¦Ã˜Â´Ã™ÂÃ˜Â±Ã˜Â©"
			},
			coin_price_static_headline_widget: {
				powered_by: "Ã˜Â¨Ã˜Â±Ã˜Â¹Ã˜Â§Ã™Å Ã˜Â© %{name_start}%{name}%{name_end}"
			},
	...
	f693: function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				...
				crypto_market_cap_comparison: "Comparaison des capitalisations de marchÃƒÂ© de crypto"
			},
			coin_price_static_headline_widget: {
				powered_by: "Fourni par %{name_start}%{name}%{name_end}"
			},
			...
			random_coin_widget: {
				disclaimer: "Clause de non responsabilitÃƒÂ© : Cet outil ne sert qu'Ãƒ  des fins de divertissement et ne constitue pas de conseils financiers",
				spin: "Tourner",
	...
	ffeb: function(e) {
		e.exports = {
			...
			coin_compare_chart_widget: {
				powered_by: "%{name_start}%{name}%{name_end} tarafÃ„Â±ndan desteklenmektedir",
				crypto_price_comparison: "Kripto Fiyat KarÃ…Å¸Ã„Â±laÃ…Å¸tÃ„Â±rmasÃ„Â±",
				crypto_market_cap_comparison: "Kripto Piyasa DeÃ„Å¸eri KarÃ…Å¸Ã„Â±laÃ…Å¸tÃ„Â±rmasÃ„Â±"
			},
			coin_price_static_headline_widget: {
				powered_by: "%{name_start}%{name}%{name_end} tarafÃ„Â±ndan desteklenmektedir"
			},
